...
physically associated with a more massive halo and cluster strongly at $\sim1.6r_{200}$ (\cite{wang09}).
 Their clustering signal is therefore determined by this associated halo, much like the clustering
...
In order to connect our findings to observational applications, we
...
the ejected halos and $\sim5\%$ without the ejected halos. By having
those selection effects on clustering signals of central galaxies,
we can possibly test the connection in the intrinsic property of central
galaxies and halos observationally.
...
bias on small scales, which mostly come from the ejected halos.
