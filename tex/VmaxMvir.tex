...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /plots/plaecholder}\caption{\label{fig:vmax-mvir}Distribution of halo mass and maximum circular
...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /plots/linearBias_wang}
...
\begin{figure}[H]
\includegraphics[width=0.8\columnwidth]{\lyxdot \lyxdot /plots/Both_smallScale_wang_log}
...
\begin{figure}[H]
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /plots/Bolshoi_smallScale_wang_log_eje}
...
\begin{figure}[H]
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /plots/Bolshoi_andrew_smallScale}\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /plots/Bolshoi_andrew_smallScale_nonEj}
