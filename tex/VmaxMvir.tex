...
we show how halos biases differ for those samples both on large scales
and small scales.
...
that the number of halos in upper and lower subsamples\textcolor{red}{{}
are }almost equal. This selection ensures that both the upper and
...
To do that, we take the ratio of the cross correlation functions between
the ``upper'' and ``lower'' subsamples and normalize it with their
linear biases. Fig. \ref{fig:small-scale} shows the ratios for several
...
becomes larger for lower halo mass samples.\textcolor{red}{{} XXX}
