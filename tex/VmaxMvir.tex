...
$^1$Department of Physics, Yale University, P.O. Box 208101, New Haven, CT \\
...
The left panel of Fig. \ref{fig:small-scale} shows
...
In the right panel of Fig. \ref{fig:small-scale}, we show the scale-dependence of assembly bias for non-ejected halos.\footnote{We remind the reader that due to the mass resolution of the MultiDark simulation, fig. \ref{fig:small-scale} only shows results for Bolshoi halos.}
...
\end{center}
\caption{\label{fig:small-scale} {\bf APH: Change y-axis label according to the updated text}. 
 Left panel: Ratio of halo-matter cross correlation functions
...
those subsamples increases smoothly with decreasing halo mass. Right panel: The same figure 
as the left panel without ejected halos only from the Bolshoi simulation. As can be seen by 
comparing these results to those in the left panel, the $V_{{\rm max}}$-dependence 
