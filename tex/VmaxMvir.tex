...
phenomenon is nicely explained in terms of the statistics of fluctuations in a Gaussian random field.\footnote{See also Chapter IX, Section D of \citet{zentner07} for a similar explanation deriving from an alternative formulation of EPS.} 
...
is that low-curvature peaks cluster more strongly relative to high-curvature peaks of the same height. Moreover, it was shown that for high-mass halos, 
their EPS-based predictions for the curvature-dependence of halo clustering were in quantitatively good agreement with that exhibited by 
simulated halos. 


%the same mass originated from the same peak height but different peak curvature cluster differently because of their different environment. Halos with shallower peak curvature, which end up to be low-$V_{{\rm max}}$ halos, tend to live in high density region and therefore cluster more strongly. At $M_{{\rm vir}}<10^{12.8}h^{-1}{\rm M_{\odot}}$, high-$V_{{\rm max}}$ halos cluster more strongly than low-$V_{{\rm max}}$ halos, and the difference in linear bias increases up to $40\%$ with decreasing halo mass. On low mass regime, mass growth of halos are affected by tidal field; high-$V_{{\rm max}}$ halos are the ones whose mass growth is suppressed by strong tidal field generated in high-density region {[}\textcolor{red}{\cite{wang_etal11,shi15}}\textcolor{black}{{]}. }Our result for linear bias is consistent with previous studies investigating clustering dependence on other parameters such as formation time and concentration {[}\cite{gao_etal05,wechsler06,gao_white07,li_etal08}{]}. Due to a tight correlation between $V_{{\rm max}}$ and those parameters, this agreement is expected. 
