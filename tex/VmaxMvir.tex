...
It is sensible that these EPS predictions are in good agreement with the clustering trends exhibited by high-mass simulated halos. A critical assumption 
underlying these EPS predictions for the assembly history of a halo is that the halo is the dominant peak in its large-scale environment. This is a well-founded assumption for high-mass end, and we see that the predictions are in good agreement with simulations in the $\mvir>\mcoll$ regime. 
